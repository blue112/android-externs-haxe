...
extern class DrawableMarginSpan  implements android.text.style.LeadingMarginSpan, android.text.style.LineHeightSpan
{

	@:overload(function(arg0:android.graphics.drawable.Drawable):Void{})
	public function new(arg0:android.graphics.drawable.Drawable,arg1:Int):Void;
