...
extern class AbstractCursor  implements android.database.CrossProcessCursor
{
	 var mUpdatedRows:java.util.HashMap<java.lang.Long, java.util.Map<java.lang.String, java.lang.Object>>;
	 var mRowIdColumnIndex:Int;
	 var mPos:Int;
	 var mCurrentRowID:java.lang.Long;
	 var mContentResolver:android.content.ContentResolver;
	 var mClosed:Bool;
