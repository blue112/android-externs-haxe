...
{
	static public var STATUS_ON_SIM_FREE:Int;
	static public var STATUS_ON_SIM_READ:Int;
	static public var STATUS_ON_SIM_UNREAD:Int;
	static public var STATUS_ON_SIM_SENT:Int;
	static public var STATUS_ON_SIM_UNSENT:Int;
	...
	static public function getDefault():android.telephony.gsm.SmsManager;
