...
extern class SmsMessage 
{
	...
	static public var MAX_USER_DATA_BYTES_WITH_HEADER:Int;
	...
	public function getMessageClass():android.telephony.SmsMessage_MessageClass;
	...
	static public function createFromPdu(arg0:java.NativeArray<Int8>):android.telephony.SmsMessage;

	public function isStatusReportMessage():Bool;

	public function getIndexOnIcc():Int;
	...
	public function getStatusOnIcc():Int;

	public function getUserData():java.NativeArray<Int8>;

	public function getIndexOnSim():Int;

	@:overload(function(arg0:String,arg1:String,arg2:String,arg3:Bool):android.telephony.SmsMessage_SubmitPdu{})
	static public function getSubmitPdu(arg0:String,arg1:String,arg2:Int16,arg3:java.NativeArray<Int8>,arg4:Bool):android.telephony.SmsMessage_SubmitPdu;
